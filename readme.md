...
- Your solution should work on a standard x86-64 Linux system with 18GB of RAM. Our reference hardware for grading performance is an AWS m5a.2xlarge instance type running Amazon Linux, an AMD EPYC CPU at 2.3 GHZ base frequency (with boosting to up to 2.6 GHZ) and 16 GB of RAM
